...
class EvacuationSystem {
    ...
    findPath(startX, startY, role = 'civilian', ffAction = 'evacuate') {
        ...
        while (openSet.length > 0) {
            ...
            // For firefighters, "reaching" the fire might mean getting adjacent to it so they don't step ON it?
            // But for simplicity, let's path to the exact coordinate. 
